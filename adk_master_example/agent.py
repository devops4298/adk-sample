...
# === Configure Vertex AI (ADC Authentication) ===
# This enables using Google Cloud ADC instead of API keys
import google.auth
from google import genai

# Get project from environment or ADC
PROJECT_ID = os.getenv("GOOGLE_CLOUD_PROJECT", "cna-g-pre-proj-eqegenai")
...
class AgentConfig:
    ...
    # Model settings (Vertex AI model names)
